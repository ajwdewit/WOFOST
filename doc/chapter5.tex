...
\begin{document}
\setcounter{page}{39}\pagenumpos{\pnbr}\selectlanguage{USenglish}
\section{  5 CROP  }
...
where\> $\Delta$W\> : Growth rate \> \> \> \> \> \> [kg Dry Matter ha$^{{\rm -1}}$ d$^{{\rm -1}}$]\\
...
\>\>   total crop\> \> \> \> \> \> [kg Dry Matter kg$^{{\rm -1}}$ CH$_{{\rm 2}}$O]
\end{tabbing}
...
\bigskip
\bigskip
\selectlanguage{USenglish}The light absorbed at a certain depth in the canopy is obtained by taking the derivative of
...
\bigskip
\bigskip
\selectlanguage{UKenglish}{\bf {\it Photosynthesis in terms of CH$_{{\rm 2}}$O\/}}\\
