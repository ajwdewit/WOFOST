...
The temperature dependent correction factor, {\bf DT$_{{\rm s}}$} (acronym: {\bf DTSMTB}) and the temperature sum required to complete stage i, {\bf $\sum$T$_{{\rm i}}$} (acronym: {\bf TSUM1} or {\bf TSUM2}) are crop
...
In \S 6.1 the calculation of the potential, T$_{{\rm p}}$, and actual the transpiration, 
...
%figure 5.5
\centering
\includegraphics[width=85mm]{\FigDir/TMPFTB.pdf}
...
of temperature and ambient CO$_{{\rm 2}}$ concentration, differences in physiological and anatomical properties of the leaves as a result of differences in leaf age and pre$-$treatment, and
