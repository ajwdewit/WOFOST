...
Figure 1.1 Daily calulations\> \> \> \> \> \> \> \> Fig\-ure 1.2  Yearly calculations
\end{tabbing}
...
Figure 1.1 presents this loop over days for one growth season, whereas figure 1.2
depicts the loop over years for one simulation run.

Another important feature of the crop growth simulation model is the comparisson of
...
\begin{figure}[htbp]
 \begin{center}\epsfig{file=\FigDir/WEERLOOP.eps,width=7.73cm} \end{center}
\end{figure}
...
\bigskip
\begin{figure}[htbp]
 \begin{center}\epsfig{file=\FigDir/CROPLOOP.eps,width=9.29cm} \end{center}
\end{figure}
...
\bigskip
\begin{figure}[htbp]
 \begin{center}\epsfig{file=\FigDir/SOILLOOP.eps,width=9.29cm} \end{center}
\end{figure}
