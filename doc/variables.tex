...
PI      \> \> R   \> ratio circumference to diameter of a circle\> \> \> \> \> \> \> $-$\\
RAD     \> \> R   \> factor to convert degrees to radians       \> \> \> \> \> \> \> rad degree$^{{\rm -1}}$\\
SC      \> \> R   \> solar constant                                     \> \> \> \> \> \> \> J m$^{{\rm -2}}$ s$^{{\rm -1}}$\\
SCA\> \> R\> array of calculated daily SC values\> \> \> \> \> \> \> J m$^{{\rm -2}}$ d$^{{\rm -1}}$\\
...
CVL\> \> R\> efficiency o conversion of assimilates into leaf dry matter\> \> \> \> \> \> \> kg kg$^{{\rm -1}}$\\
CVO\> \> R\> efficiency o conversion of assimilates into storage organ dry matter\> \> \> \> \> \> \> kg kg$^{{\rm -1}}$\\
CVR\> \> R\> efficiency o conversion of assimilates into root dry matter\> \> \> \> \> \> \> kg kg$^{{\rm -1}}$\\
CVS\> \> R\> efficiency o conversion of assimilates into stem dry matter\> \> \> \> \> \> \> kg kg$^{{\rm -1}}$\\
...
DLC\> \> R\> lower threshold day length for development\> \> \> \> \> \> \> h\\
...
\>\> \> a correction for lowet atmospheric transmission\> \> \> \> \> \> \> s d$^{{\rm -1}}$\\
...
GRLV    \> \> R   \> rate of increase in leaf blade dry matter          \> \> \> \> \> \> \> kg ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
GRRT    \> \> R   \> rate of increase in root dry matter                \> \> \> \> \> \> \> kg ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
GRST    \> \> R   \> rate of increase in stem dry matter                \> \> \> \> \> \> \> kg ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
GWRT    \> \> R   \> rate of increase in living root dry matter         \> \> \> \> \> \> \> kg ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
GWSO    \> \> R   \> rate of increase in storage organ dry matter       \> \> \> \> \> \> \> kg ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
GWST    \> \> R   \> rate of increase in living stem dry matter         \> \> \> \> \> \> \> kg ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
...
IAIRDU\> \> I\> indicates presence (1) or absence (0) of airducts in the root zone\> \> \> \> \> \> \> -\\
...
ILSLA\> \> I\> number of elements in table SLATB\> \> \> \> \> \> \> -\\
ILTMNF\> \> I\> number of elements in table TMNFTB\> \> \> \> \> \> \> -\\
ILTMPF\> \> I\> number of elements in table TMPFTB\> \> \> \> \> \> \> -\\
...
IOX\> \> I\> flag controlling calculation of wl yield without or with accounting\\
...
LAMXPP\> \> R\> maxmum leaf area (potential production)\> \> \> \> \> \> \> ha ha$^{{\rm -1}}$\\
LAMXWL\> \> R\> maxmum leaf area (water limited production)\> \> \> \> \> \> \> ha ha$^{{\rm -1}}$\\
...
MREST\> \> R\> summation over the time steps of the maintenance respirarion\> \> \> \> \> \> \> kg CH$_{{\rm 2}}$O ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
MRESTX\> \> R\> summation over the time steps of the maintenance respirarion\> \> \> \> \> \> \> kg CH$_{{\rm 2}}$O ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
\>\> \> (summary variable)\\
...
Q10\> \> R\> rel. increase in maintenance respiration per 10\degrees C increase in temp.\> \> \> \> \> \> \> -\\
...
\>\> \> respirarion (potential production)\> \> \> \> \> \> \> kg CH$_{{\rm 2}}$O ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
...
\>\> \> respirarion (water limited production)\> \> \> \> \> \> \> kg CH$_{{\rm 2}}$O ha$^{{\rm -1}}$ d$^{{\rm -1}}$\\
RFSETB\> \> R\> reduction factor of the senescence as a function \\
\>\> \> of DVS (AFGEN table)\> \> \> \> \> \> \> -\\
...
RRI\> \> R\> root length growth rate\> \> \> \> \> \> \> cm d$^{{\rm -1}}$\\
...
TBASEM\> \> R\> lower treshold temperature for emergence\> \> \> \> \> \> \> \degrees C\\
...
TMNFTB\> \> R\> correction factor of daily gross CO2 assimilation rate as a\\
...
TMPFTB\> \> R\> correction factor of maximum leaf CO2 assimilation rate as a\\
...
TSUM1\> \> R\> treshold temperature sum from emergence to anthesis\> \> \> \> \> \> \> \degrees C\\
TSUM2\> \> R\> treshold temperature sum from anthesis to maturity\> \> \> \> \> \> \> \degrees C\\
TSUME\> \> R\> temperature sum from sowing to emergence\> \> \> \> \> \> \> \degrees C\\
TSUMEM\> \> R\> treshold temperature temperature sum from sowing to emergence\> \> \> \> \> \> \> \degrees C\\
...
\>\> \> water limited production (output variable)\> \> \> \> \> \> \> kg ha$^{{\rm -1}}$\\
YSOPP\> \> R\> dry weight of dead and storage organs,\\
\>\> \> potential production (output variable)\> \> \> \> \> \> \> kg ha$^{{\rm -1}}$\\
YSOWL\> \> R\> dry weight of dead and living storage organs, \\
\>\> \> water limited production (output variable)\> \> \> \> \> \> \> kg ha$^{{\rm -1}}$\\
YSTPP\> \> R\> dry weight of dead and stems,\\
\>\> \> potential production (output variable)\> \> \> \> \> \> \> kg ha$^{{\rm -1}}$\\
...
\hspace{1.27cm}\=\hspace{1.27cm}\=\hspace{1.27cm}\=\hspace{1.27cm}\=%
\hspace{1.27cm}\=\hspace{1.27cm}\=\kill
{\bf SUBROUTINE DATES}\> \> \> (ACTION, IYEAR, IDAY, IMONTH)
\end{tabbing}
\nwln
\begin{tabbing}
\hspace{1.27cm}\=\hspace{1.27cm}\=\hspace{1.27cm}\=\hspace{1.27cm}\=%
...
ELOG10  \> \> R   \> mathematical constant (= log(10))                  \> \> \> \> \> \> \> $-$\\
...
LOGST4  \> \> R  \> mathematical constant, equal to 10$-$log(330)         \> \> \> \> \> \> \> log(cm)\\
MH      \> \> R   \> matric head of root zone                            \> \> \> \> \> \> \> cm\\
PF      \> \> R   \> pF value belonging to MH (i.e. 10$-$log(MH))          \> \> \> \> \> \> \> log(cm)\\
...
ITOLD\> \> I\> retains number of last task performed\> \> \> \> \> \> \> -\\
IYEAR\> \> I\> start year (ITASK=1), current year (ITASK=2)\> \> \> \> \> \> \> -\\
LDELT\> \> R\> time step (=1 day), local variable\\
LTIME\> \> R\> time from start of simulation, local variable\> \> \> \> \> \> \> -\\
OUTPUT\> \> L\> logical flag; (false) not output, (true) output\> \> \> \> \> \> \> -\\
PRDEL\> \> R\> time between succesive outputs (0, equal to or multiple of DELT)\> \> \> \> \> \> \> -\\
PROUT\> \> L\> logical flag;\\
R1\> \> R\> inverse of time step (if 0 $<$ DELT $<$ 1)\> \> \> \> \> \> \> d$^{{\rm -1}}$\\
TERMNL\> \> L\> logical flag; (false) FINTIM not reached, (true) FINTIM reached\> \> \> \> \> \> \> -\\
TIME\> \> R\> time from start of simulation\> \> \> \> \> \> \> -\\
TINY\> \> R\> help variable which prevents errors due to rounding\> \> \> \> \> \> \> -
\end{tabbing}
